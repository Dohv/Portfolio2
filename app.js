document.onreadystatechange = function () {
    ...
    if (document.readyState == "interactive") {
        ...
        //     const skills = document.querySelectorAll("p.skill");
        //     const sectionWidth = document.querySelector("div.section").offsetWidth;
        //     const sectionHeight = document.querySelector("div.section").offsetHeight;

        //     skills.forEach(skill => {
        //         randomTop = getRandomNumber(0, sectionHeight);
        //         randomLeft = getRandomNumber(0, sectionWidth);

        //         skill.style.top = randomTop +"px";
        //         skill.style.left = randomLeft +"px";
        //     }); 
        // }
        ...
        box1.addEventListener("click", () => {
            ...
            r_b1.forEach((box, index) => {
                ...
                setTimeout(function(){ box.classList.add('hide') }, 475);
            });
        });
